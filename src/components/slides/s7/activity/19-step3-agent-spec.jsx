...
export default function S7Activity_3_1_AgentSpec() {
  return (
    <>
      ...
      {/* Subtitle — 파일 경로 강조 */}
      <p className="text-base text-text-sub mb-5 max-w-4xl">
      ...
      {/* Code block — max-w-4xl 정렬 통일 */}
      <pre className="bg-bg-soft border border-divider rounded-xl p-4 text-xs whitespace-pre-wrap leading-relaxed max-w-4xl text-text mb-4">
{`---
