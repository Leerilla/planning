// Source: lectures/S3/lecture.md lines 744-749 (Step 0 검증 기준 4 항목)
// Type: activity (checklist 4 항목)

export default function S3ActivityStep0Validation() {
  const items = [
    'node, claude 명령이 동작하는가',
    '작업 폴더 planning_project이 생성됐는가',
  ...
  return (
    <>
      ...
      <p className="text-sm font-medium text-text-sub tracking-tight leading-relaxed mb-5 max-w-4xl">
        4개 항목 모두 통과 시 Step 1 (NotebookLM 페인포인트 추출)로 진입.
      </p>
