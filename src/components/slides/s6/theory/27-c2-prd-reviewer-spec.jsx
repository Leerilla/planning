...
// S6 T2 (2026-05-24): 강사 요구 — 파일 경로 텍스트 잘 안 보임 + 레이아웃 안맞음
//                     → 카드 헤더(파일 경로 강조) + 본문(pre) 통합, 폰트 text-sm 승격, max-w-5xl 확장
// S6 T14a (2026-05-24): 강사 요구 — 화면 겹침 → 헤더 mb 축소, 카드 헤더 py 축소, pre leading-snug
