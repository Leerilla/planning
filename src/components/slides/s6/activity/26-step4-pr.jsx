  ...
  --body "Closes #2"`}</code>
      ...
      <div className="mt-6 max-w-4xl">
        <p className="text-sm font-medium text-text mb-3">
          <span className="font-semibold">본인 리뷰 후 병합.</span> PR 본문에 <span className="bg-bg-soft px-2 py-1 rounded-md text-accent font-semibold">Closes #2</span> 키워드를 포함하면 PR을 병합할 때 Issue #2가 자동으로 닫힌다.
        </p>
      </div>
