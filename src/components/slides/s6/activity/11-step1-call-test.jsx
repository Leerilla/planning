    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 flex flex-col">
          <div className="text-xs font-medium text-text-sub uppercase tracking-wider mb-2 bg-bg-soft rounded-t px-3 py-2">
            호출 명령
          </div>
          <div className="bg-bg-soft rounded-b border border-divider border-t-0 px-4 py-3 flex-1">
