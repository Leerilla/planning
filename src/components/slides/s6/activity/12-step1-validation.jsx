// Source: lectures/S6/lecture.md lines 811-816 (#### Step 1 검증 기준)
// Type: activity (checklist 4 항목)

export default function S6ActivityStep1Validation() {
  const items = [
  ...
  return (
    <>
      ...
      <p className="text-sm font-medium text-text-sub tracking-tight leading-relaxed mb-5 max-w-4xl">
        4개 항목 모두 통과 시 Step 2 (git-committer sub-agent 작성)로 진입.
      </p>
