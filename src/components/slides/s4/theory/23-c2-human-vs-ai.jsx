    ...
    <>
      ...
      <div className="rounded border border-divider overflow-hidden max-w-6xl">
        <div className="grid grid-cols-[1fr_1.6fr_1.6fr] bg-bg-soft border-b border-divider">
          ...
          <div className="px-5 py-3 text-sm uppercase tracking-wider text-text-sub border-l border-divider">사람 검증 (기존)</div>
          <div className="px-5 py-3 text-sm uppercase tracking-wider text-accent border-l border-divider">AI 검증 루프 (현재)</div>
        </div>
        {rows.map((r, i) => (
          <div
            key={i}
          ...
          >
            ...
            <div className="px-5 py-3.5 text-base text-text-sub border-l border-divider">{r.human}</div>
            <div className="px-5 py-3.5 text-base text-text font-medium border-l border-divider">{r.ai}</div>
          </div>
        ))}
      </div>
    </>
