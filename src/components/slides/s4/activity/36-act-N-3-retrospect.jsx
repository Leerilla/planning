    ...
    <>
      ...
      <div className="rounded border border-line overflow-hidden max-w-6xl">
        <div className="grid grid-cols-[1.4fr_2.2fr_1.6fr] bg-bg-soft border-b border-line">
          ...
          <div className="px-4 py-3 text-xs uppercase tracking-wider text-accent border-l border-line">좋은 답</div>
          <div className="px-4 py-3 text-xs uppercase tracking-wider text-text-sub border-l border-line">나쁜 답</div>
        </div>
        {rows.map((r, i) => (
          <div
            key={i}
