// Source: lectures/S4/lecture.md lines 963-969 (N-2 /cost 비교)
// Type: activity (code + 메모 항목)

export default function S4Activity_N_2_Cost() {
  return (
    <>
      ...
      <p className="text-base font-medium text-text-sub tracking-tight leading-relaxed mb-5 max-w-4xl">
        Step 0의 베이스라인 토큰과 비교. <span className="highlight-mark">차이가 본 세션의 실비용</span>이다.
      </p>
