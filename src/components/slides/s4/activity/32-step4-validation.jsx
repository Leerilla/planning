// Source: lectures/S4/lecture.md lines 937-942 (Step 4 검증 기준 4)
// Type: activity (checklist)

export default function S4ActivityStep4Validation() {
  const items = [
