// Source: lectures/S2/lecture.md L377-382
// Type: example (활동 묶음 3 검증/성공 기준 — 실습 종료)

export default function S2ActivityBundle3Validation() {
  const items = [
    '발송 채널이 결정됐는가',
    '응답 알림이 설정됐는가',
  ...
  return (
    <>
      ...
      <p className="text-base font-medium text-text-sub tracking-tight leading-relaxed mb-5 max-w-4xl">
        4개 항목 모두 통과 시 과제 단계 진입 가능. 한 항목이라도 미달이면 그 항목부터 다시 채운다.
      </p>
