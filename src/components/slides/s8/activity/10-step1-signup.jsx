  ...
  return (
    <>
      {/* Header marker */}
        ...
        {/* Menu diagram — D-054: Railway + github inline code + accent */}
        <div className="flex flex-col gap-2 max-w-4xl">
          ...
          <div className="flex items-start gap-3 p-4 border border-divider bg-bg-soft rounded-xl">
            ...
            <div className="text-base text-text leading-relaxed flex-1">
              <code className="text-accent font-semibold bg-bg-soft px-1.5 py-0.5 rounded text-sm">https://railway.app</code> 접속
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 border border-divider bg-bg-soft rounded-xl">
            ...
            <div className="text-base text-text leading-relaxed flex-1">
              "Login with <code className="text-accent font-semibold bg-bg-soft px-1.5 py-0.5 rounded text-sm">GitHub</code>" 선택
            </div>
          </div>
